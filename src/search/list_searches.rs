            ...
            PromptMessage {
                ...
                content: PromptMessageContent::text(
                    "The list_searches tool shows all active search sessions:\n\n\
                     ...
                     - id: Search ID for use with get_search_results or stop_search\n\
                     ...
                     Common workflows:\n\
                     1. Check what's searching: list_searches() → See all search IDs\n\
                     2. Get results from specific search: get_search_results({\\\"search_id\\\": \\\"search_1_...\\\"}) \n\
                     3. Stop unwanted search: stop_search({\\\"search_id\\\": \\\"search_1_...\\\"})\n\n\
                     When to use:\n\
                     - Lost track of running searches\n\
                     - Want to monitor all active search operations\n\
                     - Need search IDs for other operations\n\
                     ...
                     4. get_search_results({\\\"search_id\\\": \\\"search_1\\\"}) → Get TODO results\n\
                     5. stop_search({\\\"search_id\\\": \\\"search_2\\\"}) → Cancel file search if needed",
                ),
            },
        ])
    }
